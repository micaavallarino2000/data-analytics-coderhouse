...
id_categoria INT, FOREIGN KEY (id_categoria) REFERENCES dbo.DimCategorias,
...
/* ============================================================
   ...
   id_cliente INT FOREIGN KEY (id_cliente) REFERENCES dbo.DimClientes,
   id_producto INT FOREIGN KEY (id_producto) REFERENCES dbo.DimProductos,
